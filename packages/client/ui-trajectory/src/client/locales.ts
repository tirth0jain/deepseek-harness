...
export const zh = {
  ...
  'usage.estimatedCost': '预估费用（按标价）',
  'usage.costBand.peak': '（峰时）',
  'usage.costBand.base': '（谷时）',
  'usage.costBand.mixed': '（峰时与谷时）',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'usage.estimatedCost': 'Estimated cost (list price)',
  'usage.costBand.peak': ' (peak)',
  'usage.costBand.base': ' (off-peak)',
  'usage.costBand.mixed': ' (peak and off-peak)',
