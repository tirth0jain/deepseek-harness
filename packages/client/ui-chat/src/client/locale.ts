...
export const zh = {
  ...
  'message.turnUsage.approx': '约',
  'message.turnUsage.approxHint': '本轮用量未能完整核对，为已观测 token 的近似汇总',
  'message.turnUsage.consumed': '用量 {total}',
  'message.turnUsage.model': '提供方 / 模型',
  'message.turnUsage.cost': '费用',
  'message.turnUsage.peak': '（峰值 {windows}）',
  'message.turnUsage.offPeak': '（非峰值 {windows}）',
...
export const en = {
  ...
  'message.turnUsage.approx': '~',
  'message.turnUsage.approxHint': 'Turn usage could not be fully verified; this is an approximate total of the observed tokens',
  'message.turnUsage.consumed': 'Usage {total}',
  'message.turnUsage.model': 'Provider / model',
  'message.turnUsage.cost': 'Cost',
  'message.turnUsage.peak': ' (peak {windows})',
  'message.turnUsage.offPeak': ' (off-peak {windows})',
