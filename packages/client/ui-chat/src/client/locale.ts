...
export const zh = {
  ...
  'chat.loadTurn': '加载第 {turn} 轮',
  'chat.loadTurn.aria': '加载第 {turn} 轮的完整内容，从你的消息到模型的完整回复',
  'chat.loadTurn.busy': '正在加载第 {turn} 轮…',
  ...
  'message.turnUsage.cost': '预估费用（按标价）',
  'message.turnUsage.costBand.peak': '（峰时）',
  'message.turnUsage.costBand.base': '（谷时）',
  'message.turnUsage.costBand.mixed': '（峰时与谷时）',
...
export const en = {
  ...
  'chat.loadTurn': 'Load turn {turn}',
  'chat.loadTurn.aria': 'Load all of turn {turn} — your message through the full response',
  'chat.loadTurn.busy': 'Loading turn {turn}…',
  ...
  'message.turnUsage.cost': 'Estimated cost (list price)',
  'message.turnUsage.costBand.peak': ' (peak)',
  'message.turnUsage.costBand.base': ' (off-peak)',
  'message.turnUsage.costBand.mixed': ' (peak and off-peak)',
